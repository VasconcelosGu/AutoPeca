...
public class VendaTM extends AbstractTableModel{

    private List<String[]> linhas;
    private String[] colunas = new String[]{"Codigo","Produto", "Vendedor", "Cliente", "Forma de Pagamento", "Quantidade", "Total"};
    
    public VendaTM() {
        linhas = new ArrayList<String[]>();
    }
    
    public VendaTM(List<String[]> lista) {
    ...
    public String[] getCliente(int indiceLinha) {
